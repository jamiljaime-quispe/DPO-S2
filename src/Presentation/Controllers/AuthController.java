...
public class AuthController {
    ...
    private void showAdminCancellationNotifications() {
        if (reservationService == null || userService.getLastLoggedInUserId() <= 0)
            return;
        List<Reservation> cancelled = reservationService.consumeCancelledByAdminNotifications(
